...
#ifndef HYBRIDA_TEST_KINO_ASTAR_H
#define HYBRIDA_TEST_KINO_ASTAR_H
...
//        EDTEnvironment::Ptr edt_environment_;
    ...
    public:
        ...
        bool IsOccupied(Eigen::Vector3d start_pt);

        bool checkCollisionPoint(const octomap::point3d &p, bool ignoreUnkown);

       void setEnvironment(octomap::OcTree* & map);
...
#endif //HYBRIDA_TEST_KINO_ASTAR_H
